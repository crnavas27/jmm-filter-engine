...
export function classifyRow(row) {
    ...
    const hasDemoLensLanguage = includesAny(descLower, demoLensKeywords) ||
    ...
    const matchesApparelKeyword = (keyword) => {
    ...
    const forcedLensSku = productLower.startsWith('000-') ||
