 ...
 */
export function getPrimaryTokens(desc: string): { raw: string; alpha: string } {
 ...
 */
export function getPrimaryFirstWord(desc: string): string {
  const beforeComma = (desc || '').split(',')[0] || '';
 ...
 */
export function stripRxSuffix(word: string): string {
 ...
 */
export function stripVersionSuffix(text: string): string {
 ...
 */
export function stripDescriptorPrefixes(text: string): string {
